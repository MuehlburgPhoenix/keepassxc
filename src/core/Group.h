...
public:
    ...
    TimeDelta defaultValidityPeriod() const;
    TimeDelta effectiveDefaultValidityPeriod() const;
    Group::TriState defaultValidityPeriodEnabled() const;
    ...
    void setDefaultValidityPeriod(const TimeDelta& period);
    void setDefaultValidityPeriodEnabled(TriState enable);
